...
mm";
        ...
        lockScreenTint = 0;
        passwordChars = false;
        radiusRatio = 0.7000000000000001;
        reverseScroll = false;
        scaleRatio = 0.8;
        screenRadiusRatio = 1;
      ...
      wallpaper = {
        ...
        directory = "/home/tsuki/.config/Wallpapers";
